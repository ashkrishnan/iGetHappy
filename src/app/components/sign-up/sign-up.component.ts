/*
  *Module Name    : Sign-Up                                
  *Module Purpose : The module purpose is sign-up the user
...
export class SignUpComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,private http: HttpClient,private commonService: CommonService,public dialog: MatDialog, private loginService: LoginService, private signUpService: SignUpService,private toastr: ToastrService,private location: Location,private spinnerService: Ng4LoadingSpinnerService) { 
    this.createForm();
    this.getLocation(); 
    // var emptyData =[];
  ...
  /*
    ...
    *Function Purpose : The module purpose getting user detail from local storage
    *Created date     : July 2019
    *Created By       : Mandeep Singh
  */
  getUserData(){
  ...
  /*
    ...
    *Function Purpose : As its name showing its functionality it is use for get location on the basis of country calling code and languages 
    *Created date     : July 2019
    *Created By       : Mandeep Singh
  */
  getLocation(){
  ...
  */
  createForm() {
    this.angForm = this.fb.group({
      ...
      phone_number: ['', [Validators.required,Validators.pattern(/^[0-9]\d{9}$/) ]],
...
*/
 ...
 signup(){
  ...
  formData.append('name_prefix', this.secondFrom.get('nameprefix').value);
