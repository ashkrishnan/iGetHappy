...
export class UploadDocumentsComponent implements OnInit {
  ...
  medical_proof:File;
  degree_proof:any;
  government_proof:File;
  medical_proof_name:string;
  degree_proof_name:string[]=[];
  government_proof_name:string;
  ...
  constructor(private formBuilder: FormBuilder,private profileService: ProfileService,private http: HttpClient) { 
    ...
    this.documentForm = this.formBuilder.group({
      medical_proof: ['', [Validators.required]],
      degree_proof: ['', [Validators.required]],
      government_proof: ['', [Validators.required]],
  ...
  */
  getLocation(){
    this.http.get<any>('https://pro.ip-api.com/json/?fields=16510975&key=test-demo-pro')
      .subscribe(res => 
        { 
          this.getState(res.country);
        }
    );
  }
 /*
    *Function name     : On Change Medical Proof
    *Function Purpose  : For managing change medical proof
    *Created date      : July 2019
    *Created By        : Mandeep Singh
  */
  onChangeMedicalProof(event) {
    //this.medical_proof_name = '';
    if(event.target.files[0].size !== 0){
      ...
      //if((event.target.files[0]['type'] == 'application/pdf' || (event.target.files[0]['type'] == 'image/png'))){
        // if( event.target.files[0].size > 1){
        //   this.documentForm.controls['medical_proof'].markAsTouched();
        //   this.documentForm.controls['medical_proof'].setErrors({'incorrect': true});
        //   return false;
        // }
        this.medical_proof = event.target.files[0];
        this.medical_proof_name = event.target.files[0].name;
        this.documentForm.controls['medical_proof'].markAsUntouched();
        this.medical_proof_error=false;
      }else{
        this.medical_proof = undefined;
        this.medical_proof_name = undefined;
        this.medical_proof_error=true;
        this.documentForm.controls['medical_proof'].markAsTouched();
        this.documentForm.controls['medical_proof'].pristine;
        this.documentForm.controls['medical_proof'].setErrors({'incorrect': true});
      }
    }else{
      this.documentForm.controls['medical_proof'].markAsUntouched();
 ...
 /*
    ...
    *Function Purpose  : For managing change degree proof
    *Created date      : July 2019
    *Created By        : Mandeep Singh
  */
  onChangedegreeProof(event) {
    //this.degree_proof_name = '';
    if(event.target.files[0].size !== 0){
     ...
     // if((event.target.files[0]['type'] == 'application/pdf') || (event.target.files[0]['type'] == 'image/png')){
        ...
        this.degree_proof_name = event.target.files[0].name;
        //this.documentForm.controls['degree_proof'].markAsUntouched();
        this.documentForm.controls['degree_proof'].setErrors({'incorrect': false});
        this.degree_proof_error=false;
        ...
        this.degree_proof_name = this.filename;
      }else{
        this.degree_proof = undefined;
        this.degree_proof_name = undefined;
        this.degree_proof_error=true;
        this.documentForm.controls['degree_proof'].markAsTouched();
        this.documentForm.controls['degree_proof'].pristine;
        this.documentForm.controls['degree_proof'].setErrors({'incorrect': true});
      }
    }else{
      this.documentForm.controls['medical_proof'].markAsUntouched();
      this.degree_proof_error=false;
  ...
  /*
    *Function name     : On Change govenment Proof
    *Function Purpose  : For managing change degree proof
    *Created date      : July 2019
    *Created By        : Mandeep Singh
  */
  onChangeGovernementProof(event) {
   // this.government_proof_name = '';
    if(event.target.files[0].size !== 0){
      if((event.target.files[0]['type'] == 'application/pdf') || (event.target.files[0]['type'] == 'image/png')){
        this.government_proof = event.target.files[0];
        this.government_proof_name = event.target.files[0].name;
        //this.documentForm.controls['government_proof'].markAsUntouched();
        this.government_proof_error=false;
      }else{
        this.government_proof = undefined;
        this.government_proof_name = undefined;
        this.government_proof_error=true;
        this.documentForm.controls['government_proof'].markAsTouched();
        this.documentForm.controls['government_proof'].pristine;
        this.documentForm.controls['government_proof'].setErrors({'incorrect': true});
      }
    }else{
      this.documentForm.controls['medical_proof'].markAsUntouched();
      this.government_proof_error=false;
...
/*
    *Function name     : On Change state
    *Function Purpose  : For managing change state section
    *Created date      : July 2019
    *Created By        : Mandeep Singh
  */
  changestate(event){
...
/*
    *Function name     : Validate AllForm Fields
    *Function Purpose  : For managing validationof form
    *Created date      : July 2019
    *Created By        : Mandeep Singh
  */
  ...
  /*
    ...
    *Function Purpose  : For submiting purpose
    *Created date      : July 2019
    *Created By        : Mandeep Singh
  */
  submit(){
    ...
    if(this.state){
      ...
      this.profileService.uploadDocuments(formData);
    }
  ...
  /*
    ...
    *Function Purpose  : For getting state details
    *Created date      : July 2019
    *Created By        : Mandeep Singh
  */
  getState(countryName){
    ...
    country.forEach(function (value) {
      if(value.country == countryName){
        value.states.forEach(function (val) {
          arr.push(val);
        }); 
      }
    }); 
