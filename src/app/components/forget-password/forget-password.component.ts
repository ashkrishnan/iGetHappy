/*
  ...
  *Module Purpose : Managing forgot password of registerd user
...
export class ForgetPasswordComponent implements OnInit {
  angForm: FormGroup;
  countryCallCode:any="";
  constructor(private fb: FormBuilder, private loginService: LoginService,private http: HttpClient,private location: Location) { 
    this.createForm();
  }
  ...
  /*
    ...
    *Function Purpose  : The purpose of this function's is  getting location
    *Created date      : July 2019
    *Created By        : Mandeep Singh
  */
  getLocation(){
  ...
  */
  createForm() {
    this.angForm = this.fb.group({
      ...
      phone_number: ['', [Validators.pattern(/^[0-9]\d{9}$/)] ],
    });
  }

  /*
    *Function name     : Forgot Password
    *Function Purpose  : The function is uses for forgot password api responce
    *Created date      : July 2019
    *Created By        : Mandeep Singh
  */
  forgotPassword(email, phone_number){
    //if(email.length > 0){
      console.log(this.countryCallCode);
      this.loginService.forgotPassword(email, this.countryCallCode+phone_number);
   // }
    console.log(phone_number);
  }
  /*
    *Function name     : Get Country Calling Code
    *Function Purpose  : Managing country calling code with detais
    *Created date      : July 2019
    *Created By        : Mandeep Singh
  */
  ...
  /*
    ...
    *Function Purpose  : Managing location on pages
    *Created date      : July 2019
    *Created By        : Mandeep Singh
  */
  backClicked() {
